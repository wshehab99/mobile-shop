...
<div class="copyright text-white-50 bg-dark text-center py-2">
    <p class="font-rale font-size-14">
        &copy; Copyrights 2023 Designed by <a href="#" class="color-second">Waleed Bin
            Shehab</a>
    </p>
</div>
